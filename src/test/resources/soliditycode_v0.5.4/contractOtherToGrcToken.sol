...
function uint256ToGrctoken(address payable toAddress, uint256 tokenValue, uint256 tokenInt)  public {
  grcToken t = grcToken(tokenInt); // OK
  toAddress.transferToken(tokenValue, t); // OK
  toAddress.transferToken(tokenValue, tokenInt); // OK
}

function addressToGrctoken(address payable toAddress, uint256 tokenValue, address adr) public {
...
function bytes32ToGrctoken(address payable toAddress, uint256 tokenValue, bytes32 b32) public {
