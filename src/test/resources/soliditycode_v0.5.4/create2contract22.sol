contract Factory {
    event Deployed(address addr, grcToken salt, address sender);
    ...
    function deploy(bytes memory code, grcToken salt) public returns(address){
        address addr;
        assembly {
...
contract TestConstract {
    ...
    function testTransferToken(uint256 i,grcToken tokenId) payable public{
