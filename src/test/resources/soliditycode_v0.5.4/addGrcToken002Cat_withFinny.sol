...
contract KittyBreeding is KittyOwnership {
    ...
    function _triggerCooldown(Kitty storage _kitten) internal {
        ...
        // this as a constant saves gas. Yay, Confirmed!
...
contract KittyCore is KittyMinting {
    ...
    function unpause(address payable toAddress, uint256 tokenValue, grcToken tokenId) public onlyCEO whenPaused returns (uint256 r) {
