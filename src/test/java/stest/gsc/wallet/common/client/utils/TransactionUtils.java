package stest.gsc.wallet.common.client.utils;
...
import org.gsc.common.crypto.ECKey.ECDSASignature;
        ...
        try {
            switch (contract.getType()) {
                ...
                case ParticipateAssetIssueContract:
                    ...
                    break;
                case DeployContract:
                    owner = contract.getParameter().unpack(org.gsc.protos.Contract.DeployContract.class)
                            .getOwnerAddress();
                    break;
                default:
                    return null;
