...
public class ContractScenario004 {
  ...
  public void beforeClass() {
    ...
    Assert.assertTrue(PublicMethed.sendcoin(contract004Address,20000000L,fromAddress,
        testKey002,blockingStubFull));
    logger.info(Long.toString(PublicMethed.queryAccount(contract004Key,blockingStubFull)
        .getBalance()));
    Assert.assertTrue(PublicMethed.freezeBalanceGetEnergy(contract004Address, 1000000L,
        3,1,contract004Key,blockingStubFull));
    /*    Assert.assertTrue(PublicMethed.buyStorage(5000000L,contract004Address,contract004Key,
        blockingStubFull));*/
