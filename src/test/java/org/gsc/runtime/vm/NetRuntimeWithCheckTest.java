 ...
 */
public class NetRuntimeWithCheckTest {
  ...
  public static void init() {
    ...
    //init cpu
    dbManager.getDynamicPropertiesStore().saveLatestBlockHeaderTimestamp(1565913600000L);
  ...
  public void testSuccess() {
    try {
      ...
      Assert.assertEquals(624668, trace.getReceipt().getCpuUsageTotal());
      Assert.assertEquals(50000, cpu);
      Assert.assertEquals(57466800, balance);
      Assert.assertEquals(624668 * Constant.DOT_PER_CPU,
  ...
  public void testSuccessNoNet() {
    try {
      ...
      Assert.assertEquals(6118, receipt.getCpuUsageTotal());
      Assert.assertEquals(6118, receipt.getCpuUsage());
      Assert.assertEquals(0, receipt.getCpuFee());
  ...
  private byte[] createContract()
    ...
    Assert
        .assertEquals(88529 * Constant.DOT_PER_CPU, balance + cpu * Constant.DOT_PER_CPU);
