 ...
 */
public class NetRuntimeOutOfTimeWithCheckTest {
  ...
  public static void init() {
    ...
    //init cpu
    dbManager.getDynamicPropertiesStore().saveLatestBlockHeaderTimestamp(1565993600000L);
  ...
  public void testSuccess() {
    try {
      ...
      trxCap.setResultCode(contractResult.OUT_OF_CPU);
