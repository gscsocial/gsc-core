...
public class ECKeyTest {
    ...
    public void testGetAddress() {
        ...
        System.out.println(Hex.toHexString(prefixedAddress));
        byte[] unprefixedAddress = Arrays.copyOfRange(key.getAddress(), 3, prefixedAddress.length);
        assertArrayEquals(Hex.decode(address), unprefixedAddress);
        assertArrayEquals(Wallet.getAddressPreFixByte(), Arrays.copyOfRange(prefixedAddress, 0, 3));
    }
