...
public class TxOutputCapsuleTest {
  ...
  public void testTxOutputCapsule() {
    ...
    TxOutputWrapper txOutputCapsule = new TxOutputWrapper(value, address);
    ...
    TxOutputWrapper txOutputCapsule2 = new TxOutputWrapper(value3, address3);
    ...
    TxOutputWrapper txOutputCapsule3 = new TxOutputWrapper(value5, address5);
