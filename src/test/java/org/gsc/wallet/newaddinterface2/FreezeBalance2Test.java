...
package org.gsc.wallet.newaddinterface2;
...
public class FreezeBalance2Test {
  ...
  public void testFreezeBalance2() {
    ...
    Assert.assertEquals(ret1.getCode(), GrpcAPI.Return.response_code.CONTRACT_VALIDATE_ERROR);
    Assert.assertEquals(ret1.getMessage().toStringUtf8(),
        "contract validate error : frozenBalance must be more than 1Gsc");
    ...
    ret1 = PublicMethed.freezeBalance2(fromAddress, 1000000L, 5, testKey002, blockingStubFull);
