...
public class Create2Test018 {
  ...
  @Test(enabled = false, description = "Deploy factory contract generated by new confirmed")
  ...
  public void test02TriggerCreate2ToDeployTestContract() {
    Assert.assertTrue(PublicMethed.freezeBalanceForReceiver(fromAddress, 9000_000_000_000L, 5, 1,
