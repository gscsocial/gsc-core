...
public class Create2Test024 {
  ...
  public void test01DeployFactoryContract() {
    ...
    String filePath = "./src/test/resources/soliditycode_v0.5.4/Create2Test024.sol";
  ...
  public void test02TriggerTestContract() {
    ...
    accountResource = PublicMethed.getAccountResource(user001Address, blockingStubFull);
    userCpuLimitAfter = accountResource.getCpuLimit();
    userCpuUsageAfter = accountResource.getCpuUsed();
    ...
    Assert.assertThat(ByteArray.toStr(infoById.get().getResMessage().toByteArray()),
        containsString("Not enough cpu for 'SWAP1' operation executing: "));
