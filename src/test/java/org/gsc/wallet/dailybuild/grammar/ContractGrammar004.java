...
import static org.gsc.protos.Protocol.Transaction.Result.contractResult.ILLEGAL_OPERATION_VALUE;
import static org.gsc.protos.Protocol.Transaction.Result.contractResult.OUT_OF_CPU_VALUE;
import static org.gsc.protos.Protocol.Transaction.Result.contractResult.OUT_OF_MEMORY_VALUE;
import static org.gsc.protos.Protocol.Transaction.Result.contractResult.OUT_OF_TIME_VALUE;
import static org.gsc.protos.Protocol.Transaction.Result.contractResult.REVERT_VALUE;
import static org.gsc.protos.Protocol.Transaction.Result.contractResult.STACK_TOO_LARGE_VALUE;
import static org.gsc.protos.Protocol.Transaction.Result.contractResult.STACK_TOO_SMALL_VALUE;
...
public class ContractGrammar004 {
  ...
  public void test1Grammar001() {
    Assert.assertTrue(PublicMethed
        .sendcoin(grammarAddress, 100000000000L, testNetAccountAddress, testNetAccountKey,
            blockingStubFull));
    String filePath = "./src/test/resources/soliditycode_v0.5.4/walletTestMutiSign004.sol";
  ...
  public void test2Grammar002() {
    String filePath = "./src/test/resources/soliditycode_v0.5.4/testOutOfMem.sol";
