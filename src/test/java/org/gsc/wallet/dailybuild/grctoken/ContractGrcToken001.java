...
@Slf4j
public class ContractGrcToken001 {
    ...
    private String contractDir = Configuration.getByPath("testng.conf")
            .getString("defaultParameter.contractDir");
    ...
    public void deployTransferTokenContract() {
        Assert.assertTrue(PublicMethed.sendcoin(dev001Address, 3100_000_000L, foundationAddress,
                foundationKey, blockingStubFull));

        PublicMethed.waitProduceNextBlock(blockingStubFull);

        Assert.assertTrue(PublicMethed.freezeBalanceForReceiver(foundationAddress,
        ...
        Assert.assertTrue(PublicMethed.freezeBalanceForReceiver(foundationAddress, 10_000_000L,
                5, 0, ByteString.copyFrom(dev001Address),
                foundationKey, blockingStubFull));
        ...
        String filePath = contractDir + "contractGrcToken001.sol";
        ...
        System.out.println("-----------------------------------------------------");
        PublicMethed.unFreezeBalance(foundationAddress, foundationKey, 1,
                dev001Address, blockingStubFull);
        PublicMethed.unFreezeBalance(foundationAddress, foundationKey, 0,
                dev001Address, blockingStubFull);
    }
