...
@Slf4j
public class ContractGrcToken043 {
  ...
  public void test01DeployTransferTokenContract() {
    ...
    String filePath = "./src/test/resources/soliditycode_v0.5.4/contractGrcToken043.sol";
  ...
  public void test03TriggerContract() {
    ...
    logger.info("Triger cputotal is " + infoById.get().getReceipt().getCpuUsageTotal());
    ...
    // tokenId is 0, contract not have Gsc
    ...
    // tokenId is 0, account does not have Gsc
    ...
    // tokenId is 0, transfer contract has Gsc, transfer to a contract
    tokenId = Long.toString(0);
    tokenValue = Long.valueOf(1);
    ...
    //tokenId is 0, transfer contract has Gsc, transfer to normal account
    tokenId = Long.toString(0);
    tokenValue = Long.valueOf(1);
    callValue = Long.valueOf(1);
