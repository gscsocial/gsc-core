...
@Slf4j
public class ContractGrcToken027 {
  ...
  public void deploy01TransferTokenContract() {
    ...
    String filePath = "src/test/resources/soliditycode_v0.5.4/contractGrcToken027.sol";
  ...
  public void deploy02TransferTokenContract() {
    ...
    final String triggerTxid = PublicMethed.triggerContract(transferTokenContractAddress,
        "testIndelegateCall(address,address,address,uint256,grcToken)",
