...
@Slf4j
public class ContractGrcToken037 {
  ...
  public void deploy01TransferTokenContract() {
    ...
    String filePath = "src/test/resources/soliditycode_v0.5.4/contractGrcToken037.sol";
    String contractName = "receiveGrc10";
    ...
    String contractName1 = "transferGrc10";
