...
public class ContractScenario004 {
  ...
  @Test(enabled = true)
  public void deployErc20GSCToken() {
    Assert.assertTrue(PublicMethed.sendcoin(contract004Address, 200000000L, fromAddress,
        testKey002, blockingStubFull));
    Assert.assertTrue(PublicMethed.freezeBalanceGetCpu(contract004Address, 100000000L,
        5, 1, contract004Key, blockingStubFull));
    ...
    String filePath = "./src/test/resources/soliditycode_v0.5.4/contractScenario004.sol";
