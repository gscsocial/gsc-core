package org.gsc.wallet.assetissue;
...
public class WalletTestAssetIssue001 {
  ...
  private final String testKey003 =
   ...
   //testng001、testng002、testng003、testng004
  private static final byte[] fromAddress1 = Base58
      .decodeFromBase58Check("THph9K2M2nLvkianrMGswRhz5hjSA9SfuH7");
  private static final byte[] toAddress1 = Base58
      .decodeFromBase58Check("TV75jZpdmP2juMe1dRwGrwpV6AMU6Smr1EU");
  ...
  String url = "https://github.com/gscsocial/gsc-core";
  ...
  @Test()
  public void testAchieveFinalAddress(){

      logger.info("fromAddress2:-----------------");
      byte[] fromAddress2 = Base58
              .decodeFromBase58Check("27d3byPxZXKQWfXX7sJvemJJuv5M65F3vjS");
      logger.info("fromAddress2:" + fromAddress2);
      //logger.info("fromAdress:" + new WalletTestAssetIssue001().fromAddress.toString());
      //logger.info("fromAdress1:" + new WalletTestAssetIssue001().fromAddress1.toString());
  }
