...
import org.gsc.protos.Protocol.DisconnectMessageOrBuilder;
...
public class DisconnectMessageTest extends
   ...
   * <code>.protocol.ReasonCode reason = 1;</code>
   */
  public org.gsc.protos.Protocol.ReasonCode getReason() {
    org.gsc.protos.Protocol.ReasonCode result = org.gsc.protos.Protocol.ReasonCode
        .valueOf(reason_);
    return result == null ? org.gsc.protos.Protocol.ReasonCode.UNRECOGNIZED : result;
  }

  public org.gsc.protos.Protocol.ReasonCode getName() {
    org.gsc.protos.Protocol.ReasonCode result = org.gsc.protos.Protocol.ReasonCode
        .valueOf(name_);
    return result == null ? org.gsc.protos.Protocol.ReasonCode.UNRECOGNIZED : result;
  }
  ...
  public void writeTo(com.google.protobuf.CodedOutputStream output)
    ...
    if (reason_ != org.gsc.protos.Protocol.ReasonCode.REQUESTED.getNumber()) {
      output.writeEnum(1, reason_);
    }
    if (name_ != org.gsc.protos.Protocol.ReasonCode.REQUESTED.getNumber()) {
