...
import static org.gsc.common.runtime.vm.OpCode.CALL;
import static org.gsc.common.runtime.vm.OpCode.PUSH1;
import static org.gsc.common.runtime.vm.OpCode.REVERT;
...
import org.gsc.common.runtime.vm.program.Stack;

@Slf4j(topic = "VM")

public class VM {

  // private static final Logger logger = LoggerFactory.getLogger("gscVM");
  ...
  private boolean isDeadAccount(Program program, DataWord address) {
    return program.getContractState().getAccount(convertTogscAddress(address.getLast20Bytes()))
        == null;
  }
