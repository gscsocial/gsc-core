  ...
  private void addTcpMessage(Message msg, boolean flag){
    ...
    switch (msg.getType()){
      ...
      case SYNC_BLOCK_CHAIN:
        if (flag) gscInSyncBlockChain.add(); else gscOutSyncBlockChain.add();
        break;
      case BLOCK_CHAIN_INVENTORY:
        if (flag) gscInBlockChainInventory.add(); else gscOutBlockChainInventory.add();
        break;
      case INVENTORY:
      ...
      case TRXS:
        ...
        break;
      case TRX:
        if (flag) gscInMessage.add(); else gscOutMessage.add();
        break;
      case BLOCK:
        if (flag) gscInBlock.add(); gscOutBlock.add();
        break;
      default:
        break;
    }
