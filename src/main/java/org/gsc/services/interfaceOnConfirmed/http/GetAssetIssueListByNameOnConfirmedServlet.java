...
import org.gsc.services.http.GetAssetIssueListByNameServlet;
import org.gsc.services.interfaceOnConfirmed.WalletOnConfirmed;

@Component
@Slf4j(topic = "API")
public class GetAssetIssueListByNameOnConfirmedServlet extends GetAssetIssueListByNameServlet {
