...
public class CpuCost {
    ...
    private final int GENESISCPULIMIT = 1000000;
    private final int MINCPULIMIT = 125000;
    ...
    private final int LOG_CPU = 375;
    private final int LOG_DATA_CPU = 8;
    private final int LOG_TOPIC_CPU = 375;
    private final int COPY_CPU = 3;
    private final int EXP_CPU = 10;
    private final int EXP_BYTE_CPU = 10;
    ...
    public int getGENESISCPULIMIT() {
        return GENESISCPULIMIT;
    }

    public int getMINCPULIMIT() {
        return MINCPULIMIT;
    }
    ...
    public int getLOG_CPU() {
        return LOG_CPU;
    }

    public int getLOG_DATA_CPU() {
        return LOG_DATA_CPU;
    }

    public int getLOG_TOPIC_CPU() {
        return LOG_TOPIC_CPU;
    }

    public int getCOPY_CPU() {
        return COPY_CPU;
    }

    public int getEXP_CPU() {
        return EXP_CPU;
    }

    public int getEXP_BYTE_CPU() {
        return EXP_BYTE_CPU;
    }
    ...
    private static CpuCost instance = null;

    public static CpuCost getInstance() {
        if (instance == null) {
            instance = new CpuCost();
        }
