...
public class NodeInfo {
    ...
    public static class ConfigNodeInfo {
        ...
        public long getAllowAdaptiveCpu() {
            return allowAdaptiveCpu;
        }

        public ConfigNodeInfo setAllowAdaptiveCpu(long allowAdaptiveCpu) {
            this.allowAdaptiveCpu = allowAdaptiveCpu;
            return this;
        }
    ...
    public String getConfirmedBlock() {
        return confirmedBlock;
    }

    public NodeInfo setConfirmedBlock(String confirmedBlock) {
    ...
    public Protocol.NodeInfo transferToProtoEntity() {
        ...
        builder.setConfirmedBlock(getConfirmedBlock());
        ...
        if (configNodeInfo != null) {
            ...
            configBuilder.setAllowAdaptiveCpu(configNodeInfo.getAllowAdaptiveCpu());
