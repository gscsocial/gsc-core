...
import static org.gsc.core.config.Parameter.DatabaseConstants.TRANSACTIONS_COUNT_LIMIT_MAX;
...
import org.gsc.core.config.Parameter.DatabaseConstants;
import org.gsc.core.db.api.index.Index.Iface;
import org.gsc.core.db.api.index.TransactionIndex;
...
//  }
  ...
  public Transaction getTransactionById(String id) throws NonUniqueObjectException {
    ...
    Iface<Transaction> index = indexHelper.getTransactionIndex();
