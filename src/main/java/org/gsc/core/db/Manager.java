...
import static org.gsc.core.config.Parameter.ChainConstant.SOLIDIFIED_THRESHOLD;
import static org.gsc.core.config.Parameter.ChainConstant.WITNESS_PAY_PER_BLOCK;
import static org.gsc.core.config.Parameter.NodeConstant.MAX_TRANSACTION_PENDING;
...
import org.gsc.core.actuator.Actuator;
import org.gsc.core.actuator.ActuatorFactory;
...
import org.gsc.core.capsule.utils.BlockUtil;
import org.gsc.core.config.Parameter.ChainConstant;
import org.gsc.core.config.Parameter.NodeConstant;
import org.gsc.core.config.args.Args;
import org.gsc.core.config.args.GenesisBlock;
import org.gsc.core.db.KhaosDatabase.KhaosBlock;
...
//        trx.resetResult();
  ...
  public void updateSignedWitness(BlockCapsule block) {
    ...
    try {
      adjustAllowance(witnessCapsule.getAddress().toByteArray(), ChainConstant.WITNESS_PAY_PER_BLOCK);
